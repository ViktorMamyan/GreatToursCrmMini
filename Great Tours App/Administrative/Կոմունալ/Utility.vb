...
Public Class Utility
    ...
    Friend Sub LoadData()
        Try
            Dim dt As DataTable = QueryToSqlServer("SELECT * FROM GetUtilityExpense()", CommandType.Text)
            ...
            With GridView1
                ...
                .Columns("UtilExpID").Visible = False
                .Columns("UtilityTypeID").Visible = False
    ...
    End Sub
    Sub NewItem()
        Dim f As New addUtility With {.RefForm = DirectCast(Me, Utility)}
        f.ShowDialog()
        f.Dispose()
    End Sub
    ...
    Sub EditItem()
        Try
            ...
            Dim UtilExpID As Integer = GridView1.GetDataRow(GridView1.GetSelectedRows()(0)).Item("UtilExpID")
    ...
    Sub DeleteItem()
        Try
            ...
            For i As Integer = 0 To GridView1.SelectedRowsCount - 1
                ...
                With Parameters
                    .Add(New SqlParameter("@UtilExpID", GridView1.GetDataRow(GridView1.GetSelectedRows()(i)).Item("UtilExpID")))
                End With
                ExecToSql("UtilityExpanseDelete", CommandType.StoredProcedure, Parameters.ToArray)
        ...
        Try
            ...
            If info.InRow OrElse info.InRowCell Then
                If info.Column Is Nothing Then
                    'N/A
                Else
                    If IsDBNull(view.GetRowCellValue(info.RowHandle, "UtilExpID")) OrElse view.GetRowCellValue(info.RowHandle, "UtilExpID") <= 0 Then Exit Sub
