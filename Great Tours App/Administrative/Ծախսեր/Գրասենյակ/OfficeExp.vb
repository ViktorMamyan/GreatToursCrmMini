...
Public Class OfficeExp
    ...
    Friend Sub LoadData()
        Try
            Dim dt As DataTable = QueryToSqlServer("SELECT * FROM GetOfficeExponse()", CommandType.Text)
            ...
            With GridView1
                ...
                .Columns("OfficeExponseID").Visible = False
                .Columns("OfficeExponseTypeID").Visible = False
    ...
    End Sub
    Sub NewItem()
        Dim f As New addOfficeExp With {.RefForm = DirectCast(Me, OfficeExp)}
        f.ShowDialog()
        f.Dispose()
    End Sub
    ...
    Sub EditItem()
        Try
            ...
            Dim OfficeExponseID As Integer = GridView1.GetDataRow(GridView1.GetSelectedRows()(0)).Item("OfficeExponseID")
    ...
    Sub DeleteItem()
        Try
            ...
            For i As Integer = 0 To GridView1.SelectedRowsCount - 1
                ...
                With Parameters
                    .Add(New SqlParameter("@OfficeExponseID", GridView1.GetDataRow(GridView1.GetSelectedRows()(i)).Item("OfficeExponseID")))
                End With
                ExecToSql("OfficeExponseDelete", CommandType.StoredProcedure, Parameters.ToArray)
        ...
        Try
            ...
            If info.InRow OrElse info.InRowCell Then
                If info.Column Is Nothing Then
                    'N/A
                Else
                    If IsDBNull(view.GetRowCellValue(info.RowHandle, "OfficeExponseID")) OrElse view.GetRowCellValue(info.RowHandle, "OfficeExponseID") <= 0 Then Exit Sub
