...
Public Class OtherExpense
    ...
    Friend Sub LoadData()
        Try
            Dim dt As DataTable = QueryToSqlServer("SELECT * FROM GetOtherExpense()", CommandType.Text)
            ...
            With GridView1
                ...
                .Columns("OtherExpenseID").Visible = False
    ...
    End Sub
    Sub NewItem()
        Dim f As New addOtherExpense With {.RefForm = DirectCast(Me, OtherExpense)}
        f.ShowDialog()
        f.Dispose()
    End Sub
    ...
    Sub EditItem()
        Try
            ...
            Dim OtherExpenseID As Integer = GridView1.GetDataRow(GridView1.GetSelectedRows()(0)).Item("OtherExpenseID")
    ...
    Sub DeleteItem()
        Try
            ...
            For i As Integer = 0 To GridView1.SelectedRowsCount - 1
                ...
                With Parameters
                    .Add(New SqlParameter("@OtherExpenseID", GridView1.GetDataRow(GridView1.GetSelectedRows()(i)).Item("OtherExpenseID")))
                End With
                ExecToSql("OtherExpenseDelete", CommandType.StoredProcedure, Parameters.ToArray)
        ...
        Try
            ...
            If info.InRow OrElse info.InRowCell Then
                If info.Column Is Nothing Then
                    'N/A
                Else
                    If IsDBNull(view.GetRowCellValue(info.RowHandle, "OtherExpenseID")) OrElse view.GetRowCellValue(info.RowHandle, "OtherExpenseID") <= 0 Then Exit Sub
