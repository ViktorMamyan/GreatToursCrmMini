...
Public Class Taxes
    ...
    Friend Sub LoadData()
        Try
            Dim dt As DataTable = QueryToSqlServer("SELECT * FROM GetTax()", CommandType.Text)
            ...
            With GridView1
                ...
                .Columns("TaxID").Visible = False
                .Columns("TaxTypeID").Visible = False
    ...
    End Sub
    Sub NewItem()
        Dim f As New addTax With {.RefForm = DirectCast(Me, Taxes)}
        f.ShowDialog()
        f.Dispose()
    End Sub
    ...
    Sub EditItem()
        Try
            ...
            Dim TaxID As Integer = GridView1.GetDataRow(GridView1.GetSelectedRows()(0)).Item("TaxID")
    ...
    Sub DeleteItem()
        Try
            ...
            For i As Integer = 0 To GridView1.SelectedRowsCount - 1
                ...
                With Parameters
                    .Add(New SqlParameter("@TaxID", GridView1.GetDataRow(GridView1.GetSelectedRows()(i)).Item("TaxID")))
                End With
                ExecToSql("TaxDelete", CommandType.StoredProcedure, Parameters.ToArray)
        ...
        Try
            ...
            If info.InRow OrElse info.InRowCell Then
                If info.Column Is Nothing Then
                    'N/A
                Else
                    If IsDBNull(view.GetRowCellValue(info.RowHandle, "TaxID")) OrElse view.GetRowCellValue(info.RowHandle, "TaxID") <= 0 Then Exit Sub
