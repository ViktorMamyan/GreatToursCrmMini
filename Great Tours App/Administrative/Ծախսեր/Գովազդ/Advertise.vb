...
Public Class Advertise
    ...
    Friend Sub LoadData()
        Try
            Dim dt As DataTable = QueryToSqlServer("SELECT * FROM GetAdvertise()", CommandType.Text)
            ...
            With GridView1
                ...
                .Columns("AdvertiseID").Visible = False
    ...
    End Sub
    Sub NewItem()
        Dim f As New addAdvertise With {.RefForm = DirectCast(Me, Advertise)}
        f.ShowDialog()
        f.Dispose()
    End Sub
    ...
    Sub EditItem()
        Try
            ...
            Dim AdvertiseID As Integer = GridView1.GetDataRow(GridView1.GetSelectedRows()(0)).Item("AdvertiseID")
    ...
    Sub DeleteItem()
        Try
            ...
            For i As Integer = 0 To GridView1.SelectedRowsCount - 1
                ...
                With Parameters
                    .Add(New SqlParameter("@AdvertiseID", GridView1.GetDataRow(GridView1.GetSelectedRows()(i)).Item("AdvertiseID")))
                End With
                ExecToSql("AdvertiseDelete", CommandType.StoredProcedure, Parameters.ToArray)
        ...
        Try
            ...
            If info.InRow OrElse info.InRowCell Then
                If info.Column Is Nothing Then
                    'N/A
                Else
                    If IsDBNull(view.GetRowCellValue(info.RowHandle, "AdvertiseID")) OrElse view.GetRowCellValue(info.RowHandle, "AdvertiseID") <= 0 Then Exit Sub
