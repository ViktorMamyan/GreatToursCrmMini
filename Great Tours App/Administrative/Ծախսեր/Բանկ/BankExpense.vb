...
Public Class BankExpense

    Friend Sub LoadData()
        Try
            Dim dt As DataTable = QueryToSqlServer("SELECT * FROM GetBankExpense()", CommandType.Text)
            ...
            With GridView1
                ...
                .Columns("BankExpenseID").Visible = False
    ...
    End Sub
    Sub NewItem()
        Dim f As New addBankExponse With {.RefForm = DirectCast(Me, BankExpense)}
        f.ShowDialog()
        f.Dispose()
    End Sub
    ...
    Sub EditItem()
        Try
            ...
            Dim BankExpenseID As Integer = GridView1.GetDataRow(GridView1.GetSelectedRows()(0)).Item("BankExpenseID")
            ...
            Dim EE As New editBankExponse With {.RefForm = DirectCast(Me, BankExpense), .BankExpenseID = BankExpenseID,
    ...
    Sub DeleteItem()
        Try
            ...
            For i As Integer = 0 To GridView1.SelectedRowsCount - 1
                ...
                With Parameters
                    .Add(New SqlParameter("@BankExpenseID", GridView1.GetDataRow(GridView1.GetSelectedRows()(i)).Item("BankExpenseID")))
                End With
                ExecToSql("BankExpenseDelete", CommandType.StoredProcedure, Parameters.ToArray)
        ...
        Try
            ...
            If info.InRow OrElse info.InRowCell Then
                If info.Column Is Nothing Then
                    'N/A
                Else
                    If IsDBNull(view.GetRowCellValue(info.RowHandle, "BankExpenseID")) OrElse view.GetRowCellValue(info.RowHandle, "BankExpenseID") <= 0 Then Exit Sub
