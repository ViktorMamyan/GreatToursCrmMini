...
Public Class Salary
    ...
    Friend Sub LoadData()
        Try
            Dim dt As DataTable = QueryToSqlServer("SELECT * FROM GetSalary()", CommandType.Text)
            ...
            With GridView1
                ...
                .Columns("SalaryID").Visible = False
    ...
    End Sub
    Sub NewItem()
        Dim f As New addSalary With {.RefForm = DirectCast(Me, Salary)}
        f.ShowDialog()
        f.Dispose()
    End Sub
    ...
    Sub EditItem()
        Try
            ...
            Dim SalaryID As Integer = GridView1.GetDataRow(GridView1.GetSelectedRows()(0)).Item("SalaryID")
            ...
            Dim EmployeeID As Integer = GridView1.GetDataRow(GridView1.GetSelectedRows()(0)).Item("EmployeeID")
    ...
    Sub DeleteItem()
        Try
            ...
            For i As Integer = 0 To GridView1.SelectedRowsCount - 1
                ...
                With Parameters
                    .Add(New SqlParameter("@SalaryID", GridView1.GetDataRow(GridView1.GetSelectedRows()(i)).Item("SalaryID")))
                End With
                ExecToSql("SalaryDelete", CommandType.StoredProcedure, Parameters.ToArray)
        ...
        Try
            ...
            If info.InRow OrElse info.InRowCell Then
                If info.Column Is Nothing Then
                    'N/A
                Else
                    If IsDBNull(view.GetRowCellValue(info.RowHandle, "SalaryID")) OrElse view.GetRowCellValue(info.RowHandle, "SalaryID") <= 0 Then Exit Sub
