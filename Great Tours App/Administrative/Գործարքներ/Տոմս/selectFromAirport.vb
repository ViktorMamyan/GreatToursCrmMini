...
Public Class selectFromAirport

    Public Property AirportID As Integer = -1
    Public Property Airport As String = String.Empty

    Private Sub LoadData()
        Try
            Dim dt As DataTable = QueryToSqlServer("SELECT AirportID,Airport,Code,AirportName,City,Country FROM GetAirport()", CommandType.Text)
            ...
            With GridView1
                ...
                .Columns("AirportID").Visible = False

                .Columns("Airport").Caption = "Աէրոպորտ"
                .Columns("Code").Caption = "Կոդ"
                .Columns("AirportName").Caption = "Անուն"
                .Columns("City").Caption = "Քաղաք"
    ...
    Private Sub GridView1_DoubleClick(sender As Object, e As EventArgs) Handles GridView1.DoubleClick
        Try
            ...
            AirportID = GridView1.GetFocusedDataRow.Item("AirportID")
            Airport = GridView1.GetFocusedDataRow.Item("Airport")
