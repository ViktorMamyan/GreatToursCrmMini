...
Public Class selectFood
    ...
    Public Property FoodTypeID As Integer = -1
    Public Property FoodName As String = String.Empty

    Private Sub LoadData()
        Try
            Dim dt As DataTable = QueryToSqlServer("SELECT FoodTypeID,FoodName FROM GetFoodType()", CommandType.Text)
            ...
            With GridView1
                ...
                .Columns("FoodName").Caption = "Սնունդ"
    ...
    Private Sub GridView1_DoubleClick(sender As Object, e As EventArgs) Handles GridView1.DoubleClick
        Try
            ...
            FoodTypeID = GridView1.GetFocusedDataRow.Item("FoodTypeID")
            FoodName = GridView1.GetFocusedDataRow.Item("FoodName")
