...
Public Class selectHotelType

    Public Property HotelTypeID As Integer = -1
    Public Property HotelType As String = String.Empty

    Private Sub LoadData()
        Try
            Dim dt As DataTable = QueryToSqlServer("SELECT TypeID,[Type] FROM GetHotelType()", CommandType.Text)
    ...
    Private Sub GridView1_DoubleClick(sender As Object, e As EventArgs) Handles GridView1.DoubleClick
        Try
            ...
            HotelTypeID = GridView1.GetFocusedDataRow.Item("TypeID")
            HotelType = GridView1.GetFocusedDataRow.Item("Type")
