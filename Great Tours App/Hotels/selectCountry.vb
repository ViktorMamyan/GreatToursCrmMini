...
Public Class selectCountry
    ...
    Public Property CountryID As Integer = -1
    Public Property Country As String = String.Empty

    Private Sub LoadData()
        Try
            Dim dt As DataTable = QueryToSqlServer("SELECT CountryID,Country FROM GetCountry()", CommandType.Text)
    ...
    Private Sub GridView1_DoubleClick(sender As Object, e As EventArgs) Handles GridView1.DoubleClick
        Try
            ...
            CountryID = GridView1.GetFocusedDataRow.Item("CountryID")
            Country = GridView1.GetFocusedDataRow.Item("Country")
