...
Public Class selectOperator
    ...
    Public Property TourOperatorID As Integer = -1
    ...
    Private Sub GridView1_DoubleClick(sender As Object, e As EventArgs) Handles GridView1.DoubleClick
        Try
            ...
            TourOperatorID = GridView1.GetFocusedDataRow.Item("TourOperatorID")
            OperatorName = GridView1.GetFocusedDataRow.Item("OperatorName")
