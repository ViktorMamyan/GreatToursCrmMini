...
Public Class addDirectionOperatorCombination
    ...
    Private Sub LoadOperators()
        Try
            ...
            For i As Integer = 0 To dt.Rows.Count - 1
                cbOperator.Properties.Items.Add(dt.Rows(i)("TourOperatorID"), dt.Rows(i)("OperatorName"), CheckState.Unchecked, True)
            Next
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        Try
            ...
            ExecToSql("DirectionOperatorCombinationAdd", CommandType.StoredProcedure, Parameters.ToArray)

            ID = Query_Scalar("SELECT dbo.GetLasDirectionOperatorCombinationID()")

            For i As Integer = 0 To cbOperator.Properties.Items.Count - 1
                cbOperator.Properties.Items(i).CheckState = CheckState.Unchecked
            Next
